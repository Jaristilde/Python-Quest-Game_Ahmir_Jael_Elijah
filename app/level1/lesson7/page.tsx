...
const LESSON = LEVEL1_LESSONS[6]; // Lesson 7
    ...
    if (lessonComplete) {
        return (
            <div className={styles.successOverlay}>
                ...
                <Link href="/level1/lesson8" className={`${styles.navBtn} ${styles.primary}`}>Next Lesson <ChevronRight size={18} /></Link>
            </div>
        );
    }
                ...
                {!showQuiz ? (
                    <>
                        ...
                        <div className={styles.explainBox}>
                            <p>Want to put names inside your sentences? ✨</p>
                            <p style={{ marginTop: '1rem' }}>Use the magic <code>f</code> before your quotes!</p>
                            <p style={{ marginTop: '0.5rem' }}>Put <code>{'{'}curly brackets{'}'}</code> around your names.</p>
                            <p style={{ marginTop: '1rem' }}>
                                <code>name = "Jael"</code><br />
                                <code>print(f"Hello {'{'}name{'}'}!")</code>
                            </p>
                            <p style={{ marginTop: '0.5rem' }}>Shows: <strong>Hello Jael!</strong></p>
                            <p style={{ marginTop: '1rem', color: 'var(--text-muted)' }}>It fills in the blank for you! 📝</p>
                        </div>
                        ...
                        <div className={styles.codeSection}>
                            ...
                            <div className={styles.codeBlock}>
                                ...
                                <div className={styles.codeContent}>
                                    animal = <span className={styles.string}>"cat"</span>{'\n'}
                                    sound = <span className={styles.string}>"meow"</span>{'\n'}
                                    <span className={styles.keyword}>print</span>(f<span className={styles.string}>"The {'{'}animal{'}'} goes {'{'}sound{'}'}!"</span>)
                                </div>
                            </div>
                            <div className={styles.outputBox}>
                                <div className={styles.outputLabel}>Output:</div>
                                <div className={styles.outputText}>The cat goes meow!</div>
                            </div>
                        </div>
                        ...
                        <div className={styles.codeSection}>
                            ...
                            <div className={styles.editor}>
                                ...
                                <textarea value={code} onChange={(e) => setCode(e.target.value)} placeholder={'name = "Ahmir"\nprint(f"Hello {name}!")'} spellCheck={false} />
                            </div>
                        ...
                        <div className={styles.challenges}>
                            ...
                            <ul className={styles.challengeList}>
                                <li><div className={styles.challengeCheck}></div>Make a sentence with your name</li>
                                <li><div className={styles.challengeCheck}></div>Make a sentence with your age</li>
                            </ul>
                        </div>

                        <div className={styles.tipBox}>
                            <Lightbulb size={20} className="text-amber-400 flex-shrink-0" />
                            <p><strong>Don't forget:</strong> The <code>f</code> goes right before the quote! <code>f"Hello"</code> not <code>"f Hello"</code></p>
                        </div>

                        <div className={styles.navBar}>
                            <Link href="/level1/lesson6" className={`${styles.navBtn} ${styles.secondary}`}><ChevronLeft size={18} /> Previous</Link>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className={styles.quizSection}>
                        ...
                        <p className={styles.quizQuestion}>If <code>food = "taco"</code>, what does <code>print(f"I love {'{'}food{'}'}")</code> show?</p>
                        <div className={styles.quizOptions}>
                            {['I love {food}', 'I love taco', 'I love "taco"'].map((option, idx) => (
                        ...
                        {!quizChecked ? (
                            ...
                            <div className={`${styles.quizFeedback} ${styles.error}`}>
                                <h4>Hmm, not quite! 🤔</h4>
                                <p>The f-string fills in <code>{'{'}food{'}'}</code> with the actual value: taco!</p>
