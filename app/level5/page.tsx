...
export default function Level5Hub() {
    ...
    // Check if Level 4 is complete (13 lessons, stored as levels 50-62)
        ...
        return (
            <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
                <div style={{ textAlign: 'center' }}>
                    ...
                    <h1 style={{ fontSize: '1.75rem', fontWeight: 800, marginBottom: '0.75rem' }}>Level 5 is Locked!</h1>
                    <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem', maxWidth: '300px' }}>
                        Complete all 13 lessons in Level 4 to unlock Tuples, Dictionaries & Sets!
                    </p>
                    <Link href="/level4" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.875rem 1.5rem', background: 'linear-gradient(135deg, var(--accent-primary), var(--accent-secondary))', color: '#1E1E2E', textDecoration: 'none', borderRadius: '8px', fontWeight: 600 }}>
                        <Play size={18} /> Go to Level 4
                    </Link>
                </div>
            </div>
        );
    ...
    // Level 5 lessons are stored as levels 63-75
    const completedLessons = user.progress.completedLevels
        .filter(l => l.level >= 63 && l.level <= 75)
        .map(l => l.level - 62);
        ...
        <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
            ...
            <div style={{ textAlign: 'center', padding: '2rem 1.5rem 1rem' }}>
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                    ...
                    <h1 style={{ fontSize: '1.75rem', fontWeight: 800, marginBottom: '0.25rem' }}>Level 5: Tuples, Dicts & Sets</h1>
                    <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>Organize your data like a pro!</p>
